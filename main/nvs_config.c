...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_MANUAL_FAN2_SPEED]                     = {.nvs_key_name = "manualfan2speed", .type = TYPE_U16,   .default_value = {.u16 = 100},                                         .rest_name = "manualFan2Speed",                    .min = 0,  .max = 100},
    [NVS_CONFIG_MIN_FAN_SPEED]                         = {.nvs_key_name = "minfanspeed",     .type = TYPE_U16,   .default_value = {.u16 = 25},                                          .rest_name = "minFanSpeed",                        .min = 0,  .max = 99},
    [NVS_CONFIG_MIN_FAN2_SPEED]                        = {.nvs_key_name = "minfan2speed",    .type = TYPE_U16,   .default_value = {.u16 = 25},                                          .rest_name = "minFan2Speed",                       .min = 0,  .max = 99},
